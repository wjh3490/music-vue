<template>
  <div class="swiper">
    <swiper :options="swiperOptions" v-if="swiperList.length > 0">
      <swiper-slide
      ...
      >
        <img :data-src="item.imageUrl" class="swiper-lazy swiper-img" />
...
export default {
  ...
  //       on: {
  //         click: e => {
  //           this.$emit('getDetail', e.target.offsetParent.dataset.id);
  //         }
  //       },
  //       loop: true,
  //       autoplay: {
